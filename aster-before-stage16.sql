...
\restrict gpa8reFFhTg6v97ZmIKqt19MnMyMmg61mwkhvFNNU8ce42Ivfg3giW0Vg2kVsrc
...
CREATE TABLE public.automation_runs (
    ...
    CONSTRAINT ck_automation_runs_trigger_source CHECK (((trigger_source)::text = ANY ((ARRAY['schedule'::character varying, 'manual'::character varying, 'webhook'::character varying, 'retry'::character varying])::text[])))
);
...
CREATE TABLE public.automations (
    ...
    CONSTRAINT ck_automations_trigger_type CHECK (((trigger_type)::text = ANY ((ARRAY['once'::character varying, 'interval'::character varying, 'daily'::character varying, 'weekly'::character varying, 'webhook'::character varying])::text[])))
);
...
2351eeb9-c0eb-4e7c-8a29-d329c0320fb0	1	2c4e3488a907a4f55a0a4273d7e3cee6a78abd811bc1643c88dd48737f2c6242	2026-07-18 04:58:24.567526+00	2026-07-18 06:06:07.975408+00	2026-08-17 04:58:24.567526+00	\N
\.
...
\unrestrict gpa8reFFhTg6v97ZmIKqt19MnMyMmg61mwkhvFNNU8ce42Ivfg3giW0Vg2kVsrc
