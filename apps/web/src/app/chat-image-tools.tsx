...
export function ChatImageComposer({
  ...
  const panelOpen = open || editAsset !== null;
        ...
        >
          ...
          {editAsset ? (
            <div className={styles.editAsset}>
              ...
              <div>
                <strong>Editing gallery image</strong>
                <span>
          ...
          <div className={styles.actions}>
            ...
            <button
              ...
              disabled={!prompt.trim() || !capable || working}
              type="submit"
            >
            ...
            >
              <label>
                ...
                <input
                  ...
                  placeholder={profile?.default_size ?? "provider default"}
                  value={size}
                />
              </label>
              <label>
                ...
                <input
                  ...
                  placeholder={profile?.default_quality ?? "provider default"}
                  value={quality}
                />
              </label>
              <label>
              ...
              <label>
                ...
                <input
                  ...
                  placeholder={profile?.default_background ?? "provider default"}
                  value={background}
                />
              </label>
              <label>
                ...
                <input
                  ...
                  placeholder={profile?.default_input_fidelity ?? "provider default"}
                  value={inputFidelity}
                />
              </label>
              <label className={styles.providerJson}>
                Additional provider parameters
                <textarea
                  onChange={(event) => setProviderParameters(event.target.value)}
                  rows={4}
