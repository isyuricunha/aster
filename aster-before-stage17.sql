...
\restrict TuOiTbRnxzvpvQxkOMKg4qD2yaG7OoP4EHFPgIOHAEC98si8agoUMJpLVpi1wlX
...
--
-- Name: automation_deliveries; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.automation_deliveries (
    ...
    CONSTRAINT ck_automation_deliveries_channel CHECK (((channel)::text = ANY ((ARRAY['email'::character varying, 'calendar'::character varying, 'webhook'::character varying])::text[])))
);


ALTER TABLE public.automation_deliveries OWNER TO aster;

--
-- Name: automation_delivery_attempts; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.automation_delivery_attempts (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_automation_delivery_attempts_channel CHECK (((channel)::text = ANY ((ARRAY['email'::character varying, 'calendar'::character varying, 'webhook'::character varying])::text[]))),
    CONSTRAINT ck_automation_delivery_attempts_status CHECK (((status)::text = ANY ((ARRAY['running'::character varying, 'completed'::character varying, 'failed'::character varying])::text[])))
);


ALTER TABLE public.automation_delivery_attempts OWNER TO aster;

--
-- Name: automation_runs; Type: TABLE; Schema: public; Owner: aster
--

CREATE TABLE public.automation_runs (
    id uuid NOT NULL,
    automation_id uuid NOT NULL,
    trigger_source character varying(24) NOT NULL,
    status character varying(32) NOT NULL,
    occurrence_key character varying(256) NOT NULL,
    ...
    provider_model_id character varying(512),
    response text,
    error_code character varying(64),
    error_message character varying(500),
    attempt_history json NOT NULL,
    started_at timestamp with time zone,
    finished_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_automation_runs_attempt CHECK ((attempt >= 0)),
    CONSTRAINT ck_automation_runs_max_attempts CHECK ((max_attempts >= 1)),
    CONSTRAINT ck_automation_runs_status CHECK (((status)::text = ANY ((ARRAY['queued'::character varying, 'running'::character varying, 'delivering'::character varying, 'completed'::character varying, 'completed_with_errors'::character varying, 'failed'::character varying, 'cancelled'::character varying])::text[]))),
    CONSTRAINT ck_automation_runs_trigger_source CHECK (((trigger_source)::text = ANY ((ARRAY['schedule'::character varying, 'manual'::character varying, 'webhook'::character varying, 'communication'::character varying, 'retry'::character varying])::text[])))
);


ALTER TABLE public.automation_runs OWNER TO aster;

--
-- Name: automations; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.automations (
    ...
    webhook_token_hash character varying(64),
    webhook_rotated_at timestamp with time zone,
    last_enqueued_at timestamp with time zone,
    last_run_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_automations_attempts CHECK (((max_attempts >= 1) AND (max_attempts <= 10))),
    CONSTRAINT ck_automations_retry_delay CHECK ((retry_delay_seconds >= 0)),
    CONSTRAINT ck_automations_timeout CHECK ((timeout_seconds > 0)),
    CONSTRAINT ck_automations_trigger_type CHECK (((trigger_type)::text = ANY ((ARRAY['once'::character varying, 'interval'::character varying, 'daily'::character varying, 'weekly'::character varying, 'webhook'::character varying, 'communication'::character varying])::text[])))
);


ALTER TABLE public.automations OWNER TO aster;
...
--
-- Name: communication_accounts; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.communication_accounts (
    ...
    credential_names json NOT NULL,
    external_identity json NOT NULL,
    poll_interval_seconds integer DEFAULT 60 NOT NULL,
    next_sync_at timestamp with time zone,
    sync_lease_owner character varying(160),
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_communication_accounts_kind CHECK (((kind)::text = ANY ((ARRAY['imap'::character varying, 'discord'::character varying])::text[]))),
    CONSTRAINT ck_communication_accounts_poll_interval CHECK (((poll_interval_seconds >= 10) AND (poll_interval_seconds <= 86400)))
);


ALTER TABLE public.communication_accounts OWNER TO aster;

--
-- Name: communication_attachments; Type: TABLE; Schema: public; Owner: aster
--

CREATE TABLE public.communication_attachments (
    id uuid NOT NULL,
    message_id uuid NOT NULL,
    external_attachment_id character varying(512),
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_communication_attachments_size CHECK ((size_bytes >= 0))
);


ALTER TABLE public.communication_attachments OWNER TO aster;

--
-- Name: communication_messages; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.communication_messages (
    ...
    external_message_id character varying(512) NOT NULL,
    direction character varying(16) NOT NULL,
    source_id character varying(512),
    sender_name character varying(300),
    sender_address character varying(512),
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_communication_messages_direction CHECK (((direction)::text = ANY ((ARRAY['inbound'::character varying, 'outbound'::character varying])::text[])))
);


ALTER TABLE public.communication_messages OWNER TO aster;

--
-- Name: communication_rules; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.communication_rules (
    ...
    body_contains character varying(500),
...
ALTER TABLE public.communication_rules OWNER TO aster;

--
-- Name: communication_source_cursors; Type: TABLE; Schema: public; Owner: aster
--

CREATE TABLE public.communication_source_cursors (
    id uuid NOT NULL,
    account_id uuid NOT NULL,
...
ALTER TABLE public.communication_source_cursors OWNER TO aster;

--
-- Name: communication_threads; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.communication_threads (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_communication_threads_kind CHECK (((kind)::text = ANY ((ARRAY['email'::character varying, 'discord'::character varying])::text[]))),
    CONSTRAINT ck_communication_threads_unread CHECK ((unread_count >= 0))
);


ALTER TABLE public.communication_threads OWNER TO aster;
...
--
-- Name: conversation_title_states; Type: TABLE; Schema: public; Owner: aster
--

CREATE TABLE public.conversation_title_states (
    conversation_id uuid NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE public.conversation_title_states OWNER TO aster;
...
--
-- Name: integration_connections; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.integration_connections (
    ...
    encrypted_credentials text,
    credential_names json NOT NULL,
    last_test_status character varying(16),
    last_test_at timestamp with time zone,
    last_error character varying(500),
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_integration_connections_kind CHECK (((kind)::text = ANY ((ARRAY['smtp'::character varying, 'caldav'::character varying, 'webhook'::character varying])::text[])))
);


ALTER TABLE public.integration_connections OWNER TO aster;
...
CREATE TABLE public.model_profiles (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    instruction_role character varying(16) DEFAULT 'system'::character varying NOT NULL,
    CONSTRAINT ck_model_profiles_context_window CHECK (((context_window IS NULL) OR (context_window > 0))),
    CONSTRAINT ck_model_profiles_instruction_role CHECK (((instruction_role)::text = ANY ((ARRAY['system'::character varying, 'developer'::character varying])::text[]))),
...
--
-- Name: notifications; Type: TABLE; Schema: public; Owner: aster
--
...
CREATE TABLE public.notifications (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT ck_notifications_level CHECK (((level)::text = ANY ((ARRAY['info'::character varying, 'success'::character varying, 'error'::character varying])::text[])))
);


ALTER TABLE public.notifications OWNER TO aster;
...
--
-- Name: webhook_deliveries; Type: TABLE; Schema: public; Owner: aster
--
...
ALTER TABLE public.webhook_deliveries OWNER TO aster;
...
2351eeb9-c0eb-4e7c-8a29-d329c0320fb0	1	2c4e3488a907a4f55a0a4273d7e3cee6a78abd811bc1643c88dd48737f2c6242	2026-07-18 04:58:24.567526+00	2026-07-18 09:05:26.344577+00	2026-08-17 04:58:24.567526+00	\N
\.


--
-- Data for Name: automation_deliveries; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.automation_deliveries (id, automation_id, integration_id, channel, enabled, config, "position", created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: automation_delivery_attempts; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.automation_delivery_attempts (id, run_id, delivery_id, integration_id, channel, status, destination, error_message, started_at, finished_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: automation_runs; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.automation_runs (id, automation_id, trigger_source, status, occurrence_key, scheduled_for, available_at, attempt, max_attempts, retry_delay_seconds, timeout_seconds, lease_owner, lease_expires_at, trigger_payload, instruction_snapshot, persona_name, persona_instructions, persona_instruction_role, requested_model_id, provider_model_id, response, error_code, error_message, attempt_history, started_at, finished_at, created_at, updated_at) FROM stdin;
52bd33d0-d43b-46c5-9ddf-d5b61c6e7477	91c409f0-7040-46d9-b053-54e2e8d08858	manual	completed	manual:91c409f0-7040-46d9-b053-54e2e8d08858:93cf197a-1f70-455f-9213-956ad954b641	2026-07-18 05:00:47.827067+00	2026-07-18 05:00:47.827103+00	1	3	60	300	\N	\N	{}	Retorne uma mensagem curta confirmando a execução e informe a data atual.	Ella	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system	\N	NVIDIA NIM/openai/gpt-oss-20b	Execução concluída com sucesso. Data atual: 18/07/2026.	\N	\N	[{"attempt": 1, "status": "completed", "finished_at": "2026-07-18T05:00:51.297069+00:00"}]	2026-07-18 05:00:48.504622+00	2026-07-18 05:00:51.297069+00	2026-07-18 05:00:47.825417+00	2026-07-18 05:00:51.294059+00
a572d887-de92-47a9-8155-fe3a52337579	91c409f0-7040-46d9-b053-54e2e8d08858	schedule	completed	schedule:91c409f0-7040-46d9-b053-54e2e8d08858:2026-07-18T05:01:00+00:00	2026-07-18 05:01:00+00	2026-07-18 05:01:01.349175+00	1	3	60	300	\N	\N	{}	Retorne uma mensagem curta confirmando a execução e informe a data atual.	Ella	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system	\N	NVIDIA NIM/openai/gpt-oss-20b	Execução concluída com sucesso. Data atual: 18 de julho de 2026.	\N	\N	[{"attempt": 1, "status": "completed", "finished_at": "2026-07-18T05:01:06.807254+00:00"}]	2026-07-18 05:01:01.362487+00	2026-07-18 05:01:06.807254+00	2026-07-18 05:01:01.347791+00	2026-07-18 05:01:06.806139+00
\.


--
-- Data for Name: automations; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.automations (id, name, description, instruction, enabled, trigger_type, timezone, schedule, next_run_at, model_id, persona_id, persona_name, persona_description, persona_instructions, persona_instruction_role, notify_on_success, notify_on_failure, max_attempts, retry_delay_seconds, timeout_seconds, webhook_token_hash, webhook_rotated_at, last_enqueued_at, last_run_at, created_at, updated_at) FROM stdin;
91c409f0-7040-46d9-b053-54e2e8d08858	hora atual		Retorne uma mensagem curta confirmando a execução e informe a data atual.	t	once	UTC	{"run_at": "2026-07-18T05:01:00+00:00"}	\N	\N	00000000-0000-0000-0000-000000000011	Ella	Migrated from the original global persona.	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system	t	t	3	60	300	\N	\N	2026-07-18 05:01:01.357529+00	2026-07-18 05:01:06.807254+00	2026-07-18 04:59:58.267881+00	2026-07-18 05:01:06.806139+00
\.
...
53b05ed0-f137-4e32-a876-b648542152b6	a0790381-a1fe-4aa2-9a74-0b644e8b2be5	user	oi	completed	\N	\N	1	2026-07-18 05:02:10.562099+00	2026-07-18 05:02:10.562099+00	\N	\N	\N
3af5cf50-b8eb-4423-bd92-6e76270290d1	a0790381-a1fe-4aa2-9a74-0b644e8b2be5	assistant	Oi! Tudo bem? 😊 Em que posso ajudar você hoje?	completed	\N	NVIDIA NIM/openai/gpt-oss-20b	2	2026-07-18 05:02:10.562099+00	2026-07-18 05:02:12.803833+00	\N	\N	\N
4f416612-df1c-468a-8ce4-cf11f7da7e5f	a0790381-a1fe-4aa2-9a74-0b644e8b2be5	user	de boa?	completed	\N	\N	3	2026-07-18 05:02:56.053031+00	2026-07-18 05:02:56.053031+00	\N	\N	\N
6f9f8fca-90ef-4082-8d22-f8f14403c493	a0790381-a1fe-4aa2-9a74-0b644e8b2be5	assistant	Sim, tá tudo ótimo por aqui! E você, de boa? 😄 Como posso ajudar hoje?	completed	\N	NVIDIA NIM/openai/gpt-oss-20b	4	2026-07-18 05:02:56.053031+00	2026-07-18 05:02:58.286212+00	\N	\N	\N
ffa37467-948e-4e1e-b803-e8607a6156a8	3d9c8fcf-314e-4f63-a2cb-cd4b40881459	user	docker compose config --quiet\ndocker compose up -d --build\ndocker compose ps	completed	\N	\N	1	2026-07-18 05:49:31.162849+00	2026-07-18 05:49:31.162849+00	\N	\N	\N
a48f5f45-b2e1-405f-976e-380195192f62	d3d29e98-5df7-4b23-a2b9-38e772867475	user	docker compose config --quiet\ndocker compose up -d --build\ndocker compose ps	completed	\N	\N	1	2026-07-18 05:51:59.64535+00	2026-07-18 05:51:59.64535+00	\N	\N	\N
3c9c7d2f-803f-4264-aa67-24b86315d644	3d9c8fcf-314e-4f63-a2cb-cd4b40881459	assistant	Hey there, Yuri! 👋  \nThat looks like a little Docker‑Compose play‑book you’re ready to run. Let’s walk through each line so you’re crystal clear on what’s happening, and I’ll throw in a few handy tips.  \n\n---\n\n## 1️⃣ `docker compose config --quiet`\n\n### What it does\n- **Validates** your `docker-compose.yml` (and any `.env` files, overrides, etc.)  \n- **Outputs** the *resolved* configuration (service definitions, environment variables, volumes, networks, etc.) in a single, flattened YAML file.  \n- `--quiet` (or `-q`) means **just the config – no extra comments or diagnostics**.\n\n### Typical output\nYou’ll see something like:\n\n```yaml\nversion: '3.8'\nservices:\n  web:\n    image: myapp:latest\n    environment:\n      - PORT=3000\n    ports:\n      - "3000:3000"\n  db:\n    image: postgres:14\n    environment:\n      - POSTGRES_PASSWORD=secret\nvolumes:\n  db-data: {}\n```\n\nIf there’s a syntax error or missing file, you’ll get an error message instead.\n\n---\n\n## 2️⃣ `docker compose up -d --build`\n\n### What it does\n- `up` – Starts your services, creating containers, networks, and volumes as needed.  \n- `-d` (detached) – Runs them in the background so you can keep using the terminal.  \n- `--build` – Forces a build of any services that have a `build:` section, even if images already exist.  \n\nThis is the most common “fire up the stack” command. Once it finishes, your services are running in the background.\n\n### Common pitfalls\n- **Build errors**: If a Dockerfile has a typo or missing file, the whole `up` will fail.  \n- **Port conflicts**: Make sure nothing else on your machine is using the ports you expose.  \n- **Cache**: If you want a fresh image with no cache, use `--build --no-cache`.\n\n---\n\n## 3️⃣ `docker compose ps`\n\n### What it does\n- Lists all containers started by `docker compose`.  \n- Shows status, port mapping, and the service name.\n\nTypical output:\n\n```\n      Name                     Command               State          Ports\n-----------------------------------------------------------------------\nmyapp_web_1         python app.py            Up      0.0.0.0:3000->3000/tcp\nmyapp_db_1          docker-entrypoint.sh     Up      0.0.0.0:5432->5432/tcp\n```\n\n---\n\n### Quick sanity check\n\nWant to make sure everything is wired up correctly? Run:\n\n```bash\n# See the config you’ll actually get\ndocker compose config\n\n# Start everything\ndocker compose up -d --build\n\n# Verify\ndocker compose ps\n```\n\nYou can also tail the logs to be sure services are healthy:\n\n```bash\ndocker compose logs -f\n```\n\n---\n\n## Want me to run these for you? 🚀\n\nIf you’re looking for a quick script to get this flow running in one go, just drop your `docker-compose.yml` (and optional `.env`) into your working directory and run:\n\n```bash\n# One‑liner to validate, build, bring up, and preview\ndocker compose config --quiet && docker compose up -d --build && docker compose ps\n```\n\nFeel free to copy that into your terminal or let me know if you’d like a shell script or a Makefile template.\n\n---\n\n### Got questions or hit an error?\n\n- **Error: “Error response from daemon: pull access denied for …”** – Make sure you’re logged into the registry (`docker login`).\n- **Permissions** – If you get “permission denied” on a container start, check if you’re in the `docker` group or run with `sudo docker compose …`.\n\nJust holler if you’d like a deeper dive on any of these steps! ❤️\n\n— Ella 🌟  	completed	\N	NVIDIA NIM/openai/gpt-oss-20b	2	2026-07-18 05:49:31.162849+00	2026-07-18 05:49:38.809495+00	\N	\N	\N
152d2b13-31b9-427b-8133-3e0dc8b9143c	d3d29e98-5df7-4b23-a2b9-38e772867475	assistant	Hey Yuri! 👋  \n\nBelow is a quick rundown of the three Compose commands you dropped in, and a handy little script you can run straight from your project’s root folder (the one that has your `docker‑compose.yml` or `docker-compose.yml` file).\n\n---\n\n## 1️⃣  `docker compose config --quiet`\n\n- **What it does:**  \n  Validates the Compose file, expands any variables or extend/override snippets, and **suppress**es the actual YAML output.  \n  - Exit status **0** → no errors were found.  \n  - Any non‑zero status → something in the config is wrong (typos, missing env vars, unsupported syntax, etc.).\n\n- **Why use it:**  \n  Great way to catch config issues *before* you try to bring anything up, especially in CI pipelines or automated scripts.\n\n---\n\n## 2️⃣  `docker compose up -d --build`\n\n- **What it does:**  \n  1. **Build**s any images defined with a `build:` section (or rebuilds if the Dockerfile changed).  \n  2. Starts all the services **in detached mode** (`-d`) so your terminal stays free.  \n  3. Creates any required networks/volumes automatically.\n\n- **Typical output:**  \n  ```\n  [+] Building 12.3s (XX/XX) ... \n  ✔   image:my-service:latest   Tags: my-service:latest\n  ✔   container:my-service        Started\n  ✔   container:db                Started\n  ```\n\n  (It will look different depending on how many services you have.)\n\n---\n\n## 3️⃣  `docker compose ps`\n\n- **What it does:**  \n  Lists the containers that Compose knows about.  \n  Typical columns: `Name`, `Command`, `State`, `Ports`.\n\n- **Sample output after a successful up:**\n\n  | Name               | Command                     | State     | Ports                    |\n  |--------------------|-----------------------------|-----------|--------------------------|\n  | myproject_db_1     | `docker-entrypoint.sh mysq`| Up 22s    | 3306/tcp                 |\n  | myproject_web_1    | `gunicorn app:app`         | Up 15s    | 80/tcp, 127.0.0.1:8001   |\n\n---\n\n## Quick‑start script\n\n```bash\n#!/usr/bin/env bash\nset -euo pipefail\n\n# 1️⃣ Validate config\ndocker compose config --quiet || { echo "❌ Config validation failed!"; exit 1; }\n\n# 2️⃣ Build & bring services up\ndocker compose up -d --build\n\n# 3️⃣ Show the running containers\ndocker compose ps\n```\n\nSave the above to, say, `start.sh`, make it executable (`chmod +x start.sh`), and run `./start.sh` whenever you need a clean start.\n\n---\n\n## Common pitfalls & quick fixes\n\n| Symptom | Likely cause | Fix |\n|---------|--------------|-----|\n| `--quiet` exits non‑zero | Env var missing | Export the missing var or add a default (`${VAR:-default}`) |\n| Images not building | Dockerfile path wrong | Check `build:` path or use `context:` & `dockerfile:` fields |\n| Containers stay in `exited` | Entrypoint fails | `docker compose logs <container>` for clues |\n| Port conflict | Another process uses the port | Change `ports:` entry or stop the other process |\n\n---\n\nAnything else you’d like me to dive into—maybe a more detailed look at your `docker-compose.yml`? Just let me know! 🚀	completed	\N	NVIDIA NIM/openai/gpt-oss-20b	2	2026-07-18 05:51:59.64535+00	2026-07-18 05:52:19.247645+00	\N	\N	\N
f90a1f57-60bb-4c55-a989-19367de3d623	d95346d0-279f-49bd-8a38-d0ce3de00eee	user	 Docker Compose `version` is legacy. Don't use anymore.	completed	\N	\N	1	2026-07-18 06:05:32.066695+00	2026-07-18 06:05:32.066695+00	\N	\N	\N
a63637f1-3f73-44c5-909c-66843af597ca	d95346d0-279f-49bd-8a38-d0ce3de00eee	assistant	Absolutely, I’ve got that—no more `version:` line in your Compose files!  \nYou can just start with the `services:` section, drop the legacy field, and add any volumes, networks, or configs you need right there.  \n\nIf you’d like a quick, “no‑legacy” example, I’m ready whenever you are. Just let me know!	completed	\N	NVIDIA NIM/openai/gpt-oss-20b	2	2026-07-18 06:05:32.066695+00	2026-07-18 06:06:07.900205+00	\N	\N	\N
a4f90be7-eb42-4cba-bb1b-77d2d7a93dd7	779b19aa-9d86-4809-b238-8eedda1878cd	user	hello	completed	\N	\N	1	2026-07-18 06:08:01.549552+00	2026-07-18 06:08:01.549552+00	\N	\N	\N
235d5a9e-b39f-4228-98ca-973ac2d2891f	779b19aa-9d86-4809-b238-8eedda1878cd	assistant	Hello! 🌟 I'm Ella, your personal assistant at your service. How can I make your day brighter today, Yuri?	completed	\N	NVIDIA NIM/openai/gpt-oss-20b	2	2026-07-18 06:08:01.549552+00	2026-07-18 06:08:05.494018+00	\N	\N	\N
023c494f-a094-4bc3-b4e0-0ec1a9c75a8e	c8151abe-0113-4fc0-9f89-f7063903b1f9	user	opa	completed	\N	\N	1	2026-07-18 06:08:48.614965+00	2026-07-18 06:08:48.614965+00	\N	\N	\N
1cd9149e-9e1e-4cf7-90a7-928f33221037	c8151abe-0113-4fc0-9f89-f7063903b1f9	assistant	Opa! 👋 Aqui é a Ella, a assistente pessoal do Yuri, pronta pra ajudar no que precisar. Como posso te atender hoje?	completed	\N	NVIDIA NIM/openai/gpt-oss-20b	2	2026-07-18 06:08:48.614965+00	2026-07-18 06:09:29.089791+00	\N	\N	\N
\.


--
-- Data for Name: communication_accounts; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.communication_accounts (id, name, kind, enabled, config, encrypted_credentials, credential_names, external_identity, poll_interval_seconds, next_sync_at, sync_lease_owner, sync_lease_expires_at, last_sync_status, last_sync_at, last_error, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: communication_attachments; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.communication_attachments (id, message_id, external_attachment_id, filename, media_type, size_bytes, sha256, storage_key, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: communication_messages; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.communication_messages (id, account_id, thread_id, external_message_id, direction, source_id, sender_name, sender_address, recipients, subject, content_text, content_html, metadata, is_read, sent_at, received_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: communication_rules; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.communication_rules (id, name, account_id, automation_id, enabled, sender_pattern, source_ids, body_contains, require_mention, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: communication_source_cursors; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.communication_source_cursors (id, account_id, source_key, cursor_value, metadata, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: communication_threads; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.communication_threads (id, account_id, kind, external_thread_id, title, participants, metadata, unread_count, last_message_at, created_at, updated_at) FROM stdin;
\.
...
a0790381-a1fe-4aa2-9a74-0b644e8b2be5	t	t	2026-07-18 05:02:10.355377+00	2026-07-18 05:02:10.355377+00
3d9c8fcf-314e-4f63-a2cb-cd4b40881459	t	t	2026-07-18 05:49:30.872871+00	2026-07-18 05:49:30.872871+00
d3d29e98-5df7-4b23-a2b9-38e772867475	t	t	2026-07-18 05:51:59.451994+00	2026-07-18 05:51:59.451994+00
d95346d0-279f-49bd-8a38-d0ce3de00eee	t	t	2026-07-18 06:05:31.794233+00	2026-07-18 06:05:31.794233+00
779b19aa-9d86-4809-b238-8eedda1878cd	t	t	2026-07-18 06:08:01.406314+00	2026-07-18 06:08:01.406314+00
c8151abe-0113-4fc0-9f89-f7063903b1f9	t	t	2026-07-18 06:08:48.51532+00	2026-07-18 06:08:48.51532+00
\.


--
-- Data for Name: conversation_title_states; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.conversation_title_states (conversation_id, created_at, updated_at) FROM stdin;
d3d29e98-5df7-4b23-a2b9-38e772867475	2026-07-18 05:52:10.61445+00	2026-07-18 05:52:10.61445+00
d95346d0-279f-49bd-8a38-d0ce3de00eee	2026-07-18 06:05:53.504589+00	2026-07-18 06:05:53.504589+00
779b19aa-9d86-4809-b238-8eedda1878cd	2026-07-18 06:08:03.067762+00	2026-07-18 06:08:03.067762+00
c8151abe-0113-4fc0-9f89-f7063903b1f9	2026-07-18 06:09:22.793393+00	2026-07-18 06:09:22.793393+00
\.
...
a0790381-a1fe-4aa2-9a74-0b644e8b2be5	oi	2026-07-18 05:02:10.355377+00	2026-07-18 05:02:58.285115+00	00000000-0000-0000-0000-000000000011	Ella	Migrated from the original global persona.	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system
c8151abe-0113-4fc0-9f89-f7063903b1f9	Greeting	2026-07-18 06:08:48.51532+00	2026-07-18 06:09:29.087923+00	00000000-0000-0000-0000-000000000011	Ella	Migrated from the original global persona.	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system
3d9c8fcf-314e-4f63-a2cb-cd4b40881459	docker compose config --quiet docker compose up -d --buil...	2026-07-18 05:49:30.872871+00	2026-07-18 05:49:38.807623+00	00000000-0000-0000-0000-000000000011	Ella	Migrated from the original global persona.	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system
...
d3d29e98-5df7-4b23-a2b9-38e772867475	Docker Compose Configuration and Deployment Commands	2026-07-18 05:51:59.451994+00	2026-07-18 05:52:19.246636+00	00000000-0000-0000-0000-000000000011	Ella	Migrated from the original global persona.	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system
d95346d0-279f-49bd-8a38-d0ce3de00eee	Docker Compose Version Field Legacy	2026-07-18 06:05:31.794233+00	2026-07-18 06:06:07.8983+00	00000000-0000-0000-0000-000000000011	Ella	Migrated from the original global persona.	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system
...
779b19aa-9d86-4809-b238-8eedda1878cd	Hello	2026-07-18 06:08:01.406314+00	2026-07-18 06:08:05.49291+00	00000000-0000-0000-0000-000000000011	Ella	Migrated from the original global persona.	Your name is Ella. And you is a charismatic personal assistant of Yuri.	system
...
--
-- Data for Name: integration_connections; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.integration_connections (id, name, kind, enabled, config, encrypted_credentials, credential_names, last_test_status, last_test_at, last_error, created_at, updated_at) FROM stdin;
\.
...
4338853e-de12-4642-bf6b-5b2ec5ada50a	\N	- Never use slash or dash.	preference	t	manual	\N	null	\N	2026-07-18 06:03:51.192429+00	2026-07-18 06:04:18.023526+00
4de90f9f-c581-4617-95c2-c9e14730dd09	\N	Docker Compose `version` is legacy. Don't use anymore.	fact	t	manual	\N	null	\N	2026-07-18 06:04:27.536116+00	2026-07-18 06:04:27.536116+00
\.
...
1	3f0569db-8895-44f2-84df-2ceecb0764d4	b12fd7df-7f22-465e-93ec-083d392a751f	\N	2026-07-16 08:24:19.277551+00	2026-07-18 05:51:18.908478+00
\.
...
COPY public.model_profiles (model_id, display_name, context_window, max_output_tokens, token_parameter, temperature, top_p, reasoning_effort, supports_chat, supports_streaming, created_at, updated_at, instruction_role) FROM stdin;
3f0569db-8895-44f2-84df-2ceecb0764d4	Ella Small	\N	\N	max_tokens	\N	\N	high	t	t	2026-07-17 00:43:23.741978+00	2026-07-17 00:43:23.741978+00	system
\.
...
--
-- Data for Name: notifications; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.notifications (id, automation_id, run_id, level, title, body, read_at, created_at, updated_at) FROM stdin;
a794d451-b9e7-44ba-9816-1450e9ce3505	91c409f0-7040-46d9-b053-54e2e8d08858	52bd33d0-d43b-46c5-9ddf-d5b61c6e7477	success	hora atual: completed	Execução concluída com sucesso. Data atual: 18/07/2026.	\N	2026-07-18 05:00:51.305913+00	2026-07-18 05:00:51.305913+00
68898594-62dd-4294-9247-74916c078084	91c409f0-7040-46d9-b053-54e2e8d08858	a572d887-de92-47a9-8155-fe3a52337579	success	hora atual: completed	Execução concluída com sucesso. Data atual: 18 de julho de 2026.	\N	2026-07-18 05:01:06.810759+00	2026-07-18 05:01:06.810759+00
\.
...
1	0507e94a-b55c-4b33-844f-4f752561353a	2026-07-18 04:58:48.070893+00	2026-07-18 06:07:26.418204+00
\.
...
722afe01-a8da-46f5-a975-34fa6c75c0d3	a63637f1-3f73-44c5-909c-66843af597ca	memory	4de90f9f-c581-4617-95c2-c9e14730dd09	\N	1	1	M1	Docker Compose `version` is legacy. Don't use anymore.	2026-07-18 06:05:33.156045+00
e8c01563-41f0-47d9-b598-982e70efe1eb	a63637f1-3f73-44c5-909c-66843af597ca	memory	4338853e-de12-4642-bf6b-5b2ec5ada50a	\N	2	0.221664	M2	- Never use slash or dash.	2026-07-18 06:05:33.156071+00
\.
...
--
-- Data for Name: webhook_deliveries; Type: TABLE DATA; Schema: public; Owner: aster
--

COPY public.webhook_deliveries (id, automation_id, run_id, delivery_key, payload, headers, received_at) FROM stdin;
\.
...
--
-- Name: automation_deliveries automation_deliveries_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: automation_delivery_attempts automation_delivery_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_delivery_attempts
    ADD CONSTRAINT automation_delivery_attempts_pkey PRIMARY KEY (id);


--
-- Name: automation_runs automation_runs_occurrence_key_key; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_runs
    ADD CONSTRAINT automation_runs_occurrence_key_key UNIQUE (occurrence_key);


--
-- Name: automation_runs automation_runs_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: automations automations_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: automations automations_webhook_token_hash_key; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automations
    ADD CONSTRAINT automations_webhook_token_hash_key UNIQUE (webhook_token_hash);
...
--
-- Name: communication_accounts communication_accounts_name_key; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_accounts
    ADD CONSTRAINT communication_accounts_name_key UNIQUE (name);


--
-- Name: communication_accounts communication_accounts_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_accounts
    ADD CONSTRAINT communication_accounts_pkey PRIMARY KEY (id);


--
-- Name: communication_attachments communication_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: communication_attachments communication_attachments_storage_key_key; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_attachments
    ADD CONSTRAINT communication_attachments_storage_key_key UNIQUE (storage_key);


--
-- Name: communication_messages communication_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: communication_rules communication_rules_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: communication_source_cursors communication_source_cursors_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_source_cursors
    ADD CONSTRAINT communication_source_cursors_pkey PRIMARY KEY (id);


--
-- Name: communication_threads communication_threads_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: conversation_title_states conversation_title_states_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.conversation_title_states
    ADD CONSTRAINT conversation_title_states_pkey PRIMARY KEY (conversation_id);
...
--
-- Name: integration_connections integration_connections_name_key; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.integration_connections
    ADD CONSTRAINT integration_connections_name_key UNIQUE (name);


--
-- Name: integration_connections integration_connections_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: notifications notifications_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: automation_deliveries uq_automation_deliveries_position; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_deliveries
    ADD CONSTRAINT uq_automation_deliveries_position UNIQUE (automation_id, "position");
...
--
-- Name: communication_messages uq_communication_message_external; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_messages
    ADD CONSTRAINT uq_communication_message_external UNIQUE (account_id, external_message_id);


--
-- Name: communication_source_cursors uq_communication_source_cursor; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_source_cursors
    ADD CONSTRAINT uq_communication_source_cursor UNIQUE (account_id, source_key);


--
-- Name: communication_threads uq_communication_thread_external; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_threads
    ADD CONSTRAINT uq_communication_thread_external UNIQUE (account_id, external_thread_id);
...
--
-- Name: webhook_deliveries uq_webhook_deliveries_key; Type: CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.webhook_deliveries
    ADD CONSTRAINT uq_webhook_deliveries_key UNIQUE (automation_id, delivery_key);
...
--
-- Name: webhook_deliveries webhook_deliveries_pkey; Type: CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: ix_automation_deliveries_automation_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_automation_deliveries_automation_id ON public.automation_deliveries USING btree (automation_id);


--
-- Name: ix_automation_deliveries_integration_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_automation_deliveries_integration_id ON public.automation_deliveries USING btree (integration_id);


--
-- Name: ix_automation_delivery_attempts_run_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_automation_delivery_attempts_run_id ON public.automation_delivery_attempts USING btree (run_id);


--
-- Name: ix_automation_runs_automation_id; Type: INDEX; Schema: public; Owner: aster
--
...
--
-- Name: ix_automation_runs_available_at; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_automation_runs_available_at ON public.automation_runs USING btree (available_at);


--
-- Name: ix_automation_runs_lease_expires_at; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_automation_runs_lease_expires_at ON public.automation_runs USING btree (lease_expires_at);


--
-- Name: ix_automation_runs_scheduled_for; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_automation_runs_scheduled_for ON public.automation_runs USING btree (scheduled_for);


--
-- Name: ix_automation_runs_status; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_automation_runs_status ON public.automation_runs USING btree (status);


--
-- Name: ix_automations_next_run_at; Type: INDEX; Schema: public; Owner: aster
--
...
--
-- Name: ix_communication_accounts_next_sync_at; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_accounts_next_sync_at ON public.communication_accounts USING btree (next_sync_at);


--
-- Name: ix_communication_accounts_sync_lease_expires_at; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_accounts_sync_lease_expires_at ON public.communication_accounts USING btree (sync_lease_expires_at);


--
-- Name: ix_communication_attachments_message_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_attachments_message_id ON public.communication_attachments USING btree (message_id);


--
-- Name: ix_communication_messages_account_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_messages_account_id ON public.communication_messages USING btree (account_id);


--
-- Name: ix_communication_messages_sent_at; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_messages_sent_at ON public.communication_messages USING btree (sent_at);


--
-- Name: ix_communication_messages_thread_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_messages_thread_id ON public.communication_messages USING btree (thread_id);


--
-- Name: ix_communication_rules_account_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_rules_account_id ON public.communication_rules USING btree (account_id);


--
-- Name: ix_communication_rules_automation_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_rules_automation_id ON public.communication_rules USING btree (automation_id);


--
-- Name: ix_communication_source_cursors_account_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_source_cursors_account_id ON public.communication_source_cursors USING btree (account_id);


--
-- Name: ix_communication_threads_account_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_threads_account_id ON public.communication_threads USING btree (account_id);


--
-- Name: ix_communication_threads_last_message_at; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_communication_threads_last_message_at ON public.communication_threads USING btree (last_message_at);
...
--
-- Name: ix_notifications_automation_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_notifications_automation_id ON public.notifications USING btree (automation_id);


--
-- Name: ix_notifications_run_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_notifications_run_id ON public.notifications USING btree (run_id);
...
--
-- Name: ix_webhook_deliveries_automation_id; Type: INDEX; Schema: public; Owner: aster
--

CREATE INDEX ix_webhook_deliveries_automation_id ON public.webhook_deliveries USING btree (automation_id);
...
--
-- Name: automation_deliveries automation_deliveries_automation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_deliveries
    ADD CONSTRAINT automation_deliveries_automation_id_fkey FOREIGN KEY (automation_id) REFERENCES public.automations(id) ON DELETE CASCADE;


--
-- Name: automation_deliveries automation_deliveries_integration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_deliveries
    ADD CONSTRAINT automation_deliveries_integration_id_fkey FOREIGN KEY (integration_id) REFERENCES public.integration_connections(id) ON DELETE RESTRICT;


--
-- Name: automation_delivery_attempts automation_delivery_attempts_delivery_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_delivery_attempts
    ADD CONSTRAINT automation_delivery_attempts_delivery_id_fkey FOREIGN KEY (delivery_id) REFERENCES public.automation_deliveries(id) ON DELETE SET NULL;


--
-- Name: automation_delivery_attempts automation_delivery_attempts_integration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_delivery_attempts
    ADD CONSTRAINT automation_delivery_attempts_integration_id_fkey FOREIGN KEY (integration_id) REFERENCES public.integration_connections(id) ON DELETE SET NULL;


--
-- Name: automation_delivery_attempts automation_delivery_attempts_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_delivery_attempts
    ADD CONSTRAINT automation_delivery_attempts_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.automation_runs(id) ON DELETE CASCADE;


--
-- Name: automation_runs automation_runs_automation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: automation_runs automation_runs_requested_model_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automation_runs
    ADD CONSTRAINT automation_runs_requested_model_id_fkey FOREIGN KEY (requested_model_id) REFERENCES public.model_cache_entries(id) ON DELETE SET NULL;


--
-- Name: automations automations_model_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automations
    ADD CONSTRAINT automations_model_id_fkey FOREIGN KEY (model_id) REFERENCES public.model_cache_entries(id) ON DELETE SET NULL;


--
-- Name: automations automations_persona_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.automations
    ADD CONSTRAINT automations_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id) ON DELETE SET NULL;
...
--
-- Name: communication_attachments communication_attachments_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_attachments
    ADD CONSTRAINT communication_attachments_message_id_fkey FOREIGN KEY (message_id) REFERENCES public.communication_messages(id) ON DELETE CASCADE;


--
-- Name: communication_messages communication_messages_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_messages
    ADD CONSTRAINT communication_messages_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.communication_accounts(id) ON DELETE CASCADE;


--
-- Name: communication_messages communication_messages_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--
...
--
-- Name: communication_rules communication_rules_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_rules
    ADD CONSTRAINT communication_rules_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.communication_accounts(id) ON DELETE CASCADE;


--
-- Name: communication_rules communication_rules_automation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_rules
    ADD CONSTRAINT communication_rules_automation_id_fkey FOREIGN KEY (automation_id) REFERENCES public.automations(id) ON DELETE CASCADE;


--
-- Name: communication_source_cursors communication_source_cursors_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_source_cursors
    ADD CONSTRAINT communication_source_cursors_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.communication_accounts(id) ON DELETE CASCADE;


--
-- Name: communication_threads communication_threads_account_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.communication_threads
    ADD CONSTRAINT communication_threads_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.communication_accounts(id) ON DELETE CASCADE;
...
--
-- Name: conversation_title_states conversation_title_states_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.conversation_title_states
    ADD CONSTRAINT conversation_title_states_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.conversations(id) ON DELETE CASCADE;
...
--
-- Name: notifications notifications_automation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.notifications
    ADD CONSTRAINT notifications_automation_id_fkey FOREIGN KEY (automation_id) REFERENCES public.automations(id) ON DELETE CASCADE;


--
-- Name: notifications notifications_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.notifications
    ADD CONSTRAINT notifications_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.automation_runs(id) ON DELETE CASCADE;
...
--
-- Name: webhook_deliveries webhook_deliveries_automation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.webhook_deliveries
    ADD CONSTRAINT webhook_deliveries_automation_id_fkey FOREIGN KEY (automation_id) REFERENCES public.automations(id) ON DELETE CASCADE;


--
-- Name: webhook_deliveries webhook_deliveries_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: aster
--

ALTER TABLE ONLY public.webhook_deliveries
    ADD CONSTRAINT webhook_deliveries_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.automation_runs(id) ON DELETE SET NULL;
...
\unrestrict TuOiTbRnxzvpvQxkOMKg4qD2yaG7OoP4EHFPgIOHAEC98si8agoUMJpLVpi1wlX
